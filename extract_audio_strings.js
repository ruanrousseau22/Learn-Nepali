...
function run(argv){
  ...
  var conf={ne:{src:'lang/ne.js',out:'audio_strings.json'},km:{src:'lang/km.js',out:'audio_strings_km.json'},my:{src:'lang/my.js',out:'audio_strings_my.json'},si:{src:'lang/si.js',out:'audio_strings_si.json'},lo:{src:'lang/lo.js',out:'audio_strings_lo.json'},ps:{src:'lang/ps.js',out:'audio_strings_ps.json'},mn:{src:'lang/mn.js',out:'audio_strings_mn.json'},bn:{src:'lang/bn.js',out:'audio_strings_bn.json'},ur:{src:'lang/ur.js',out:'audio_strings_ur.json'},uz:{src:'lang/uz.js',out:'audio_strings_uz.json'},xh:{src:'lang/xh.js',out:'audio_strings_xh.json'},am:{src:'lang/am.js',out:'audio_strings_am.json'},jv:{src:'lang/jv.js',out:'audio_strings_jv.json'},nef:{src:'faith/ne.js',out:'audio_strings_nef.json'},kmf:{src:'faith/km.js',out:'audio_strings_kmf.json'},myf:{src:'faith/my.js',out:'audio_strings_myf.json'},sif:{src:'faith/si.js',out:'audio_strings_sif.json'},lof:{src:'faith/lo.js',out:'audio_strings_lof.json'},psf:{src:'faith/ps.js',out:'audio_strings_psf.json'},bnf:{src:'faith/bn.js',out:'audio_strings_bnf.json'},mnf:{src:'faith/mn.js',out:'audio_strings_mnf.json'},urf:{src:'faith/ur.js',out:'audio_strings_urf.json'},uzf:{src:'faith/uz.js',out:'audio_strings_uzf.json'},xhf:{src:'faith/xh.js',out:'audio_strings_xhf.json'},amf:{src:'faith/am.js',out:'audio_strings_amf.json'},jvf:{src:'faith/jv.js',out:'audio_strings_jvf.json'}}[lang];
  if(!conf)return 'usage: osascript -l JavaScript extract_audio_strings.js ne|km|my|si|lo|ps|mn|bn|ur|uz|jv|xh|nef|kmf|myf|sif|lof|psf|bnf|mnf|urf|uzf|jvf|xhf|am|amf [--check]';
