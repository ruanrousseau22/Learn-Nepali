...
{t:'fill',q:'Complete: What is this?',s:'ဒါ ___ လဲ',o:['ဘာ','ဒါဘာလဲ','အဲဒါ','ဒါရေပါ'],a:0}]},
...
{t:'fill',q:'Complete: This is water',s:'ဒါ ___ ပါ',o:['ရေ','ဒါဘာလဲ','ဟိုဟာ','ဒါရေပါ'],a:0}]},
...
{t:'fill',q:'Complete: She drinks water',s:'သူ ___ သောက်တယ်',o:['ရေ','လာတယ်','ကျွန်မ','သွားတယ်'],a:0}]},
...
{t:'fill',q:'Complete: He eats a meal',s:'သူ ထမင်း ___',o:['စားတယ်','လာတယ်','သွားတယ်','သောက်တယ်'],a:0}]},
...
{t:'fill',q:'Complete: He will eat a meal',s:'သူ ထမင်း ___',o:['စားမယ်','မနက်ဖြန်','မနက်ဖြန်လာမယ်','လုပ်မယ်'],a:0}]},
...
{t:'fill',q:'Complete: I will do (it) tomorrow (man speaking)',s:'ကျွန်တော် မနက်ဖြန် ___',o:['လုပ်မယ်','သွားမယ်','ကျွန်မ','သူ'],a:0}]},
...
{t:'fill',q:'Complete: She does not go',s:'သူ ___',o:['မသွားဘူး','စားတယ်','ကျွန်မ','မသောက်ဘူး'],a:0}]},
...
{t:'fill',q:'Complete: I do not go (woman speaking)',s:'ကျွန်မ ___',o:['မသွားဘူး','မသောက်ဘူး','သူ','သိတယ်'],a:0}]},
...
{t:'fill',q:'Complete: Will you eat a meal?',s:'ထမင်း ___',o:['စားမလား','သွားလား','ဟုတ်လား','ဟုတ်တယ်'],a:0}]},
...
{t:'fill',q:'Complete: Are you going tomorrow?',s:'___ သွားမလား',o:['မနက်ဖြန်','ဟုတ်တယ်','သွားလား','ဟုတ်လား'],a:0}]},
...
{t:'fill',q:'Complete: What will you eat?',s:'___ စားမလဲ',o:['ဘာ','ဘယ်သူ','ဘယ်မှာလဲ','ဘယ်သူလဲ'],a:0}]},
...
{t:'fill',q:'Complete: Who is it?',s:'___ လဲ',o:['ဘယ်သူ','ဒါဘာလဲ','ဘာ','ဒါ'],a:0}]},
...
{t:'fill',q:'Complete: I want to go tomorrow (man speaking)',s:'ကျွန်တော် ___ သွားချင်တယ်',o:['မနက်ဖြန်','ကျွန်မ','စားချင်တယ်','သောက်ချင်တယ်'],a:0}]},
...
{t:'fill',q:'Complete: I like tea (woman speaking)',s:'ကျွန်မ လက်ဖက်ရည် ___',o:['ကြိုက်တယ်','သောက်ချင်တယ်','မကြိုက်ဘူး','ရေ'],a:0}]},
...
{t:'fill',q:'Complete: (I) stay at home',s:'အိမ် မှာ ___',o:['နေတယ်','စားတယ်','အိမ်မှာနေတယ်','ဆိုင်'],a:0}]},
...
{t:'fill',q:'Complete: (I) drink tea at the shop',s:'ဆိုင် ___ လက်ဖက်ရည် သောက်တယ်',o:['မှာ','ကျောင်း','အိမ်','နေတယ်'],a:0}]},
...
{t:'fill',q:'Complete: (She) goes to the market',s:'ဈေး ___ သွားတယ်',o:['ကို','မှာ','ဈေးကိုသွားတယ်','မန္တလေး'],a:0}]},
...
{t:'fill',q:'Complete: Will you go to Yangon?',s:'ရန်ကုန် ___ သွားမလား',o:['ကို','ဈေးကိုသွားတယ်','လား','အိမ်မှာနေတယ်'],a:0}]},
...
{t:'fill',q:'Complete: As for me, I like tea (man speaking)',s:'ကျွန်တော်က လက်ဖက်ရည် ___',o:['ကြိုက်တယ်','ဈေးကိုသွားတယ်','ဘယ်က','ဈေး'],a:0}]},
...
{t:'fill',q:'Complete: (She) comes from the market',s:'ဈေး က ___',o:['လာတယ်','အိမ်မှာနေတယ်','ဘယ်က','ကျွန်တော်က'],a:0}]},
...
{t:'fill',q:'Complete: (I) will go with a friend',s:'သူငယ်ချင်း နဲ့ ___',o:['သွားမယ်','မှာ','စားတယ်','ရေ'],a:0}]},
...
{t:'fill',q:'Complete: (I) will eat with family',s:'မိသားစု နဲ့ ___',o:['စားမယ်','သွားမယ်','သူငယ်ချင်း','အိမ်'],a:0}]},
...
{t:'mc',q:'Review — which means "eight (၈)"?',o:['ရှစ်','လေး','ဒီနေ့','ရတယ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) eat fish curry — fish curry eat',s:'ငါး ဟင်း ___',o:['စားတယ်','စားချင်တယ်','နို့','ထမင်း'],a:0}]},
...
{t:'fill',q:'Complete: (I) drink coffee with milk — coffee milk-with drink',s:'ကော်ဖီ နို့ နဲ့ ___',o:['သောက်တယ်','ကြက်သား','ဟင်း','သစ်သီး'],a:0}]},
...
{t:'fill',q:'Complete: Coffee, please',s:'ကော်ဖီ ___',o:['ပေးပါ','နဲ့','ဒါပဲ','သစ်သီး'],a:0}]},
...
{t:'fill',q:'Complete: Milk tea, please — tea milk-with please-give',s:'လက်ဖက်ရည် နို့ ___ ပေးပါ',o:['နဲ့','လက်ဖက်ရည်ဆိုင်','ရေ','ကော်ဖီ'],a:0}]},
...
{t:'fill',q:'Complete: three children',s:'ကလေး ___ ယောက်',o:['သုံး','ခု','သုံးခု','ကောင်'],a:0}]},
...
{t:'fill',q:'Complete: two people — person two counter',s:'လူ နှစ် ___',o:['ယောက်','ခု','ကောင်','ကလေး'],a:0}]},
...
{t:'fill',q:'Complete: One coffee, please — coffee one cup please-give',s:'ကော်ဖီ တစ် ___ ပေးပါ',o:['ခွက်','တစ်ခွက်ပေးပါ','နှစ်','လက်ဖက်ရည်နှစ်ခွက်'],a:0}]},
...
{t:'fill',q:'Complete: Water two cups, please',s:'ရေ ___ ခွက် ပေးပါ',o:['နှစ်','တစ်','ဘယ်နှယောက်လဲ','ကလေးနှစ်ယောက်'],a:0}]},
...
{t:'fill',q:'Complete: The fish is expensive — fish price-big',s:'ငါး ___',o:['ဈေးကြီးတယ်','ဈေးပေါတယ်','ဒါ','ပိုက်ဆံ'],a:0}]},
...
{t:'fill',q:'Complete: How much is the fish?',s:'___ ဘယ်လောက် လဲ',o:['ငါး','ဈေးကြီးတယ်','ဈေးပေါတယ်','ကျပ်'],a:0}]},
...
{t:'fill',q:'Complete: five thousand kyat',s:'ငါး ထောင် ___',o:['ကျပ်','တစ်ထောင်','ငါးထောင်ကျပ်','တစ်'],a:0}]},
...
{t:'fill',q:'Complete: How much? Five hundred kyat. — 500 kyat',s:'ငါး ___ ကျပ်',o:['ရာ','နှစ်','တစ်','ငါးထောင်ကျပ်'],a:0}]},
...
{t:'fill',q:'Complete: Will you buy fish?',s:'___ ဝယ်မလား',o:['ငါး','ရောင်းတယ်','ဈေးကြီးတယ်','ဈေးပေါတယ်'],a:0}]},
...
{t:'fill',q:'Complete: I will take it — take + future',s:'ယူ ___',o:['မယ်','ဝယ်တယ်','ကျွန်မ','ဒါဘယ်လောက်လဲ'],a:0}]},
...
{t:'fill',q:'Complete: five o’clock in the evening — evening five hour',s:'ညနေ ငါး ___',o:['နာရီ','သုံးနာရီခွဲ','ငါးနာရီ','ငါးနာရီခွဲ'],a:0}]},
...
{t:'fill',q:'Complete: half past five',s:'ငါး ___ ခွဲ',o:['နာရီ','သုံးနာရီ','ဘယ်နှ','ငါးနာရီ'],a:0}]},
...
{t:'fill',q:'Complete: (I) will come on Friday — Friday-day come-will',s:'သောကြာနေ့ ___',o:['လာမယ်','အင်္ဂါ','တနင်္လာ','ကြာသပတေး'],a:0}]},
...
{t:'fill',q:'Complete: (I) will go on Saturday — Saturday-day go-will',s:'စနေနေ့ ___',o:['သွားမယ်','စနေ','လာမယ်','ကြာသပတေး'],a:0}]},
...
{t:'fill',q:'Complete: The market is not good',s:'ဈေး ___',o:['မကောင်းဘူး','ကြီးတယ်','သေးတယ်','လက်ဖက်ရည်ဆိုင်'],a:0}]},
...
{t:'fill',q:'Complete: Is the shop big? — shop bigs-question',s:'___ ကြီးလား',o:['ဆိုင်','မကောင်းဘူး','ကောင်းတယ်','သေးတယ်'],a:0}]},
...
{t:'fill',q:'Complete: The fish curry is sweet',s:'ငါးဟင်း ___',o:['ချိုတယ်','ရေ','အေးတယ်','ရေအေးတယ်'],a:0}]},
...
{t:'fill',q:'Complete: The curry is spicy',s:'ဟင်း ___',o:['စပ်တယ်','လက်ဖက်ရည်ပူတယ်','ရေအေးတယ်','ရေ'],a:0}]},
...
{t:'fill',q:'Complete: I like green (woman speaking)',s:'ကျွန်မ ___ ကြိုက်တယ်',o:['အစိမ်း','အဖြူ','အပြာ','အနီ'],a:0}]},
...
{t:'fill',q:'Complete: Do you like red?',s:'___ ကြိုက်လား',o:['အနီ','အဖြူ','အစိမ်း','ကျွန်မ'],a:0}]},
...
{t:'fill',q:'Complete: This is better — this more-goods',s:'ဒါ ___',o:['ပိုကောင်းတယ်','ထက်','ပို','ပိုကြီးတယ်'],a:0}]},
...
{t:'fill',q:'Complete: The teashop is the best',s:'လက်ဖက်ရည်ဆိုင် ___ ပါ',o:['အကောင်းဆုံး','ပို','ပိုကြီးတယ်','အကြီးဆုံး'],a:0}]},
...
{t:'fill',q:'Complete: Are you tired?',s:'ပင်ပန်း ___',o:['လား','ကျွန်တော်','ရေဆာတယ်','ဝမ်းနည်းတယ်'],a:0}]},
...
{t:'fill',q:'Complete: I am hungry (man speaking)',s:'ကျွန်တော် ___',o:['ဗိုက်ဆာတယ်','ကျွန်မ','ပင်ပန်းတယ်','ရေဆာတယ်'],a:0}]},
...
{t:'fill',q:'Complete: The hot season is very hot — hot-season hots',s:'နွေရာသီ ___',o:['ပူတယ်','မိုး','ဒီနေ့','မိုးရွာတယ်'],a:0}]},
...
{t:'fill',q:'Complete: It is raining today — today rain falls',s:'ဒီနေ့ ___',o:['မိုးရွာတယ်','နေပူတယ်','မိုးရာသီ','လေ'],a:0}]},
...
{t:'fill',q:'Complete: My head aches — head bites',s:'___ ကိုက်တယ်',o:['ခေါင်း','ခေါင်းကိုက်တယ်','ဆရာဝန်','နေမကောင်းဘူး'],a:0}]},
...
{t:'fill',q:'Complete: I am not feeling well (woman speaking)',s:'ကျွန်မ ___',o:['နေမကောင်းဘူး','ပေးပါ','ဆရာဝန်','ကျွန်တော်'],a:0}]},
...
{t:'fill',q:'Complete: (He) bought fruit yesterday',s:'မနေ့က ___ ဝယ်ခဲ့တယ်',o:['သစ်သီး','သွားခဲ့တယ်','ဈေး','လာခဲ့တယ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) went to the market yesterday',s:'မနေ့က ဈေး ကို ___',o:['သွားခဲ့တယ်','ဝယ်ခဲ့တယ်','လာခဲ့တယ်','သစ်သီး'],a:0}]},
...
{t:'fill',q:'Complete: She is coming now',s:'သူ ___',o:['လာနေတယ်','ခဲ့','စားနေတယ်','ချင်'],a:0}]},
...
{t:'fill',q:'Complete: It is raining right now — rain falls-staying',s:'___ ရွာနေတယ်',o:['မိုး','ချင်','သူ','လာနေတယ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) have tried fish curry once',s:'ငါးဟင်း တစ်ခါ ___',o:['စားဖူးတယ်','မန္တလေး','ခဲ့','မ…ဖူးဘူး'],a:0}]},
...
{t:'fill',q:'Complete: Have you ever been to Mandalay?',s:'မန္တလေး ___ သွားဖူးလား',o:['ကို','သွားဖူးတယ်','နေ','မစားဖူးဘူး'],a:0}]},
...
{t:'fill',q:'Complete: The rain has arrived — rain arrive-news',s:'မိုး ___',o:['ရောက်ပြီ','ရောက်တယ်','တယ်','အလုပ်'],a:0}]},
...
{t:'fill',q:'Complete: The work is finished — work finish-already',s:'အလုပ် ___',o:['ပြီးပြီ','ရပြီ','တယ်','မယ်'],a:0}]},
...
{t:'fill',q:'Complete: I can speak a little Burmese (man speaking)',s:'ကျွန်တော် မြန်မာလို ___ ပြောတတ်တယ်',o:['နည်းနည်း','ပြောတယ်','သူ','သွားနိုင်တယ်'],a:0}]},
...
{t:'fill',q:'Complete: She knows how to speak Burmese',s:'သူ ___ ပြောတတ်တယ်',o:['မြန်မာလို','ချင်','မသွားနိုင်ဘူး','နိုင်'],a:0}]},
...
{t:'fill',q:'Complete: She works at the school',s:'သူ ကျောင်း ___ အလုပ်လုပ်တယ်',o:['မှာ','အလုပ်','ရမယ်','မနက်ဖြန်'],a:0}]},
...
{t:'fill',q:'Complete: Do you have to go?',s:'သွားရ ___',o:['မလား','ကျောင်း','မ…ရဘူး','ကျွန်မ'],a:0}]},
...
{t:'fill',q:'Complete: Please come to my house — house to come-please',s:'အိမ် ___ လာပါ',o:['ကို','ခဏ','ခဏစောင့်ပါ','ထိုင်ပါ'],a:0}]},
...
{t:'fill',q:'Complete: Please wait a moment',s:'___ စောင့်ပါ',o:['ခဏ','လာပါ','ကို','စားပါ'],a:0}]},
...
{t:'fill',q:'Complete: (I) will take a taxi to Yangon',s:'ရန်ကုန် ကို ___ စီးမယ်',o:['တက္ကစီ','ဘတ်စ်ကား','ဆိုင်ကယ်','ကားစီးတယ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) ride the train — train ride',s:'___ စီးတယ်',o:['ရထား','ကား','ဆိုင်ကယ်','တက္ကစီ'],a:0}]},
...
{t:'fill',q:'Complete: Go straight, please',s:'___ သွားပါ',o:['တည့်တည့်','ခဏစောင့်ပါ','ကျောင်း','ညာကွေ့'],a:0}]},
...
{t:'fill',q:'Complete: Turn right at the school — school at right-turn',s:'ကျောင်း ___ ညာကွေ့',o:['မှာ','တည့်တည့်သွားပါ','တည့်တည့်','ခဏစောင့်ပါ'],a:0}]},
...
{t:'fill',q:'Complete: Is the station near? — station nears-question',s:'___ နီးလား',o:['ဘူတာ','ဝေးတယ်','ဈေး','ဝေးလား'],a:0}]},
...
{t:'fill',q:'Complete: Is the airport far?',s:'လေဆိပ် ___',o:['ဝေးလား','ဒီနားမှာ','ရှိတယ်','ဟိုမှာ'],a:0}]},
...
{t:'fill',q:'Complete: What time does the bus leave?',s:'___ ဘယ်အချိန် ထွက်လဲ',o:['ဘတ်စ်ကား','ခု','ရောက်တယ်','လက်မှတ်'],a:0}]},
...
{t:'fill',q:'Complete: Ticket, please',s:'လက်မှတ် ___',o:['ပေးပါ','ရထား','ရောက်တယ်','ထွက်တယ်'],a:0}]},
...
{t:'fill',q:'Complete: Key, please',s:'သော့ ___',o:['ပေးပါ','ဟိုတယ်','အခန်းရှိလား','အခန်း'],a:0}]},
...
{t:'fill',q:'Complete: Do you have a room?',s:'___ ရှိလား',o:['အခန်း','လက်ဖက်ရည်ဆိုင်','ဒီနားမှာ','မရှိဘူး'],a:0}]},
...
{t:'fill',q:'Complete: What date is today?',s:'___ ဘယ်နှရက် လဲ',o:['ဒီနေ့','လာမယ်','ဒီလ','ကို'],a:0}]},
...
{t:'fill',q:'Complete: (I) will work this year',s:'___ အလုပ်လုပ်မယ်',o:['ဒီနှစ်','မြန်မာ','နှစ်','နာရီ'],a:0}]},
...
{t:'fill',q:'Complete: (I) will call tonight — night phone-call-will',s:'___ ဖုန်းဆက်မယ်',o:['ည','ကျွန်တော်','နံပါတ်','စာပို့တယ်'],a:0}]},
...
{t:'fill',q:'Complete: Please send a message — message send-please',s:'စာ ___',o:['ပို့ပါ','နံပါတ်','ကျွန်တော်','မနက်ဖြန်'],a:0}]},
...
{t:'fill',q:'Complete: (I) eat because (I) am hungry — hungry-because eat',s:'ဗိုက်ဆာလို့ ___',o:['စားတယ်','ပြီးတော့','ဒါပေမဲ့','ဘာလို့လဲ'],a:0}]},
...
{t:'fill',q:'Complete: Why will you not eat? — why not-eat-question',s:'ဘာလို့ ___',o:['မစားတာလဲ','ဗိုက်ဆာလို့စားတယ်','လို့','စားတယ်'],a:0}]},
...
{t:'fill',q:'Complete: If it rains, (I) will not go',s:'မိုးရွာရင် ___',o:['မသွားဘူး','ရင်','ပိုက်ဆံရှိရင်','ဗိုက်ဆာရင်'],a:0}]},
...
{t:'fill',q:'Complete: If (you) are hungry, please eat',s:'ဗိုက်ဆာရင် ___',o:['စားပါ','မိုးရွာရင်မသွားဘူး','ရင်','မသွားဘူး'],a:0}]},
...
{t:'fill',q:'Complete: (I) do not understand. Please say it again.',s:'နားမလည်ဘူး ___',o:['ပြန်ပြောပါ','ထင်တယ်','ကောင်းတယ်လို့ထင်တယ်','နားလည်တယ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) think it is good',s:'ကောင်းတယ်လို့ ___',o:['ထင်တယ်','lost','နားမလည်ဘူး','နားလည်တယ်'],a:0}]},
...
{t:'fill',q:'Complete: What work do you do?',s:'ဘာ ___ လုပ်လဲ',o:['အလုပ်','လယ်သမား','ကျောင်းသား','ကျွန်မ'],a:0}]},
...
{t:'fill',q:'Complete: I am a student (woman speaking)',s:'ကျွန်မ ___ ပါ',o:['ကျောင်းသူ','အလုပ်','ဆရာဝန်','ဘာအလုပ်လုပ်လဲ'],a:0}]},
...
{t:'fill',q:'Complete: Do you sing? — song sing-know-how-question',s:'သီချင်း ___',o:['ဆိုတတ်လား','သီချင်းဆိုတယ်','ဘောလုံးကန်တယ်','သီချင်းနားထောင်တယ်'],a:0}]},
...
{t:'fill',q:'Complete: I like to play football (man speaking)',s:'___ ဘောလုံးကန် ချင်တယ်',o:['ကျွန်တော်','ရေကူးတယ်','ဘောလုံးကန်တယ်','သီချင်းဆိုတယ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) get up in the morning',s:'မနက် ___',o:['ထတယ်','သော့','ကုတင်','စားတယ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) shower in the morning',s:'မနက် ___',o:['ရေချိုးတယ်','ကုတင်','တံခါး','စားတယ်'],a:0}]},
...
{t:'fill',q:'Complete: Be careful! It is raining.',s:'သတိထားပါ ___',o:['မိုးရွာနေတယ်','ပျောက်သွားပြီ','နားမလည်ဘူး','ကူညီပါ'],a:0}]},
...
{t:'fill',q:'Complete: Please help — (I) do not understand',s:'ကူညီပါ ___',o:['နားမလည်ဘူး','ဖုန်း','ရဲ','မိုးရွာနေတယ်'],a:0}]},
...
{t:'fill',q:'Complete: Do you speak Burmese? Just a little!',s:'မြန်မာလို ပြောတတ်လား ___',o:['နည်းနည်းပဲ','မြန်မာ','သိပ်မကြိုက်ဘူး','အရမ်း'],a:0}]},
...
{t:'fill',q:'Complete: Mother and father are coming',s:'အမေ နဲ့ ___ လာနေတယ်',o:['အဖေ','မိသားစု','သမီး','နှစ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) am not married yet — married not-have (soft no)',s:'အိမ်ထောင် ___',o:['မရှိဘူး','သား','အိမ်ထောင်ရှိတယ်','ကလေးရှိလား'],a:0}]},
...
{t:'fill',q:'Complete: not yet',s:'သေး ___',o:['(မ…သေးဘူး)','မနက်ဖြန်','ရှိသေးတယ်','ကလေးရှိလား'],a:0}]},
...
{t:'fill',q:'Complete: (I) am a foreigner, but (I) speak a little Burmese',s:'နိုင်ငံခြားသား ပါ ဒါပေမဲ့ မြန်မာလို ___ ပြောတတ်တယ်',o:['နည်းနည်း','စကား','စကားပြောတယ်','အင်္ဂလိပ်လို'],a:0}]},
...
{t:'fill',q:'Complete: When will you come?',s:'ဘယ်တော့ ___',o:['လာမလဲ','ရန်ကုန်','ဘယ်မှာလဲ','ဘယ်တော့လာမလဲ'],a:0}]},
...
{t:'fill',q:'Complete: Finally, (I) sleep',s:'နောက်ဆုံး ___',o:['အိပ်တယ်','နောက်မှ','ပြီးရင်','သောက်တယ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) do not need a bag — bag no-need (အိတ် eiq bag)',s:'အိတ် ___',o:['မလိုဘူး','ယူတယ်','ရေ','ဘာ'],a:0}]},
...
{t:'fill',q:'Complete: The train is slow, but the motorbike is fast',s:'ရထား ___ ဒါပေမဲ့ ဆိုင်ကယ် မြန်တယ်',o:['နှေးတယ်','ဖြည်းဖြည်းပြောပါ','စားပါ','ဖြည်းဖြည်း'],a:0}]},
...
{t:'fill',q:'Complete: (I) wear a longyi',s:'လုံချည် ___',o:['ဝတ်တယ်','အရမ်း','ဖိနပ်','အင်္ကျီ'],a:0}]},
...
{t:'fill',q:'Complete: (I) like dogs a lot — dog really like',s:'ခွေး ___ ကြိုက်တယ်',o:['အရမ်း','ငှက်','ကြီးတယ်','ဒါပေမဲ့'],a:0}]},
...
{t:'fill',q:'Complete: (I) live in a small village',s:'ရွာ သေးသေးလေး ___ နေတယ်',o:['မှာ','သွားမယ်','ပင်လယ်','ရှိတယ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) forgot the name',s:'နာမည် ___',o:['မေ့သွားပြီ','သတိရတယ်','မှတ်မိတယ်','သတိထားပါ'],a:0}]},
...
{t:'fill',q:'Complete: Will you come along? — come-along-question',s:'လိုက် ___',o:['မလား','အတူတူသွားမယ်','ဒီနှစ်','ကို'],a:0}]},
...
{t:'fill',q:'Complete: (I) need to exchange money — money exchange must',s:'___ လဲရမယ်',o:['ပိုက်ဆံ','ထောင်','ငါး','ငွေ'],a:0}]},
...
{t:'fill',q:'Complete: First of all, (I) will exchange money',s:'ပထမဆုံး ___ လဲမယ်',o:['ပိုက်ဆံ','အတန်း','ပထမ','ဒုတိယ'],a:0}]},
...
{t:'fill',q:'Complete: (I) must go to the bank',s:'ဘဏ် ကို ___',o:['သွားရမယ်','စာပို့တယ်','မနက်ဖြန်','ပိုက်ဆံလဲတယ်'],a:0}]},
...
{t:'fill',q:'Complete: Take care! See you!',s:'ဂရုစိုက်ပါ ___',o:['တွေ့မယ်','မြန်မာစကား','ပျင်းတယ်','စိတ်'],a:0}]},
...
{t:'fill',q:'Complete: (I) am really glad — really glad',s:'အရမ်း ___',o:['ဝမ်းသာတယ်','inviting','အလည်လာပါ','ပြန်လာမယ်'],a:0}]},
...
{t:'fill',q:'Complete: The mango is really sweet',s:'သရက်သီး ___ ချိုတယ်',o:['အရမ်း','ငှက်ပျောသီး','နာနတ်သီး','အုန်းသီး'],a:0}]},
...
{t:'fill',q:'Complete: No problem. See you later, OK?',s:'ကိစ္စမရှိပါဘူး ___',o:['နောက်တွေ့မယ်နော်','ကျေးဇူးတင်ပါတယ်','ဟုတ်တယ်','တော်ပြီ'],a:0}]},
...
/* Short-term — MYANMAR edition (July 2026). Contextualized: the teashop as
   the living room (lahpeq yeh, free plain-tea refills, taw bi), hsaya
   address for skilled men, the eaten-yet greeting, meterless taxis agreed
   through the window, kyat in thousands with calculator bargaining, crisp
   dollars for changers, power-cut torches. Roman is primary. */

const MY_TRIP={
  title:'Short-term',
  native:'ခရီးတို',
  frames:[
    {s:'ဘယ်မှာလဲ',sr:' beh hma leh?',en:'Where is the ___?',t:'Ask where anything is',
     items:[['ဈေး','zei','market'],['ဟိုတယ်','ho teh','hotel'],['ဆေးရုံ','hsei youn','hospital'],['အိမ်သာ','ein tha','toilet'],['ဘတ်စ်ကား','baq sa ka','bus'],['အခန်း','a hkan','room']]},
    {s:'ရှိလား',sr:' shi la?',en:'Do you have ___?',t:'Ask if something is there',
     items:[['အခန်း','a hkan','a room'],['ရေ','ye','water'],['လက်ဖက်ရည်','lahpeq yeh','tea'],['ကော်ဖီ','kaw hpi','coffee'],['ထမင်း','htamin','food']]},
    {s:'ပေးပါ',sr:' pei ba',en:'___, please.',t:'Ask for something politely',
     items:[['ရေ','ye','water'],['လက်ဖက်ရည်','lahpeq yeh','tea'],['ကော်ဖီ','kaw hpi','coffee'],['ထမင်း','htamin','food'],['ဒါ','da','this one']]},
    {s:'ဘယ်လောက်လဲ',sr:' beh lauq leh?',en:'How much is ___?',t:'Ask any price',
     items:[['ဒါ','da','this'],['အခန်း','a hkan','the room'],['လက်ဖက်ရည်','lahpeq yeh','the tea'],['ကော်ဖီ','kaw hpi','the coffee']]}
  ],
  sections:[
    {id:'first',t:'First words',d:'Add ba and it turns polite',
     note:'<b>mingalaba</b> is the visitor&rsquo;s hello — always right. Burmese goodbyes announce the leaving: <b>thwa daw meh</b>, I am off. The little <b>ba</b> on the end of anything makes it polite.',
     lines:[['မင်္ဂလာပါ','mingalaba','hello'],
      ['ကျေးဇူးတင်ပါတယ်','kyeizu tin ba de','thank you'],
      ['တောင်းပန်ပါတယ်','taun ban ba de','sorry'],
      ['ဟုတ်ကဲ့','houq keh','yes'],
      ['မဟုတ်ဘူး','ma houq bu','no'],
      ['ရပြီ','ya bi','got it · OK now'],
      ['ကိစ္စမရှိပါဘူး','keiq sa ma shi ba bu','no problem'],
      ['သွားတော့မယ်','thwa daw meh','goodbye — I am off']]},
    {id:'polite',t:'Being polite',d:'The respectful address',
     note:'<b>hsaya</b> — teacher — is the respectful address for any man skilled at his work: drivers, guides, waiters. A woman is <b>hsayama</b>. You will be told <b>hpanaq chuq ba</b> — please take off your shoes — at every doorstep.',
     lines:[['ဆရာ','hsaya','sir (any skilled man)'],
      ['ဆရာမ','hsayama','madam · teacher (woman)'],
      ['ခဏစောင့်ပါ','hkana saun ba','wait a moment, please'],
      ['ထိုင်ပါ','htain ba','please sit'],
      ['လာပါ','la ba','please come'],
      ['ဖိနပ်ချွတ်ပါ','hpanaq chuq ba','shoes off, please (you will be told)']]},
    {id:'meet',t:'Meeting someone',d:'Introductions',
     note:'Give your name plus <b>ba</b> and you have introduced yourself — the gendered I (men <b>kyundaw</b>, women <b>kyama</b>) can wait for the course.',
     lines:[['နာမည်ဘယ်လိုခေါ်လဲ','nameh beh lo hkaw leh','what is your name?'],
      ['ဘယ်ကလာလဲ','beh ga la leh','where are you from?'],
      ['နားမလည်ဘူး','na ma leh bu','I do not understand'],
      ['ပြန်ပြောပါ','pyan pyaw ba','please say it again'],
      ['ဖြည်းဖြည်းပြောပါ','hpyei hpyei pyaw ba','please speak slowly']]},
    {id:'patterns',t:'Sentence patterns',d:'Four frames that do the work',
     ...
     lines:[]},
    {id:'hear',t:'What you will hear',d:'The eaten-yet greeting',
     note:'<b>htamin sa pi bi la?</b> — eaten rice yet? — is a greeting, not lunch planning. <b>sa pi bi</b> answers it. In a teashop <b>ba sa ma leh</b> — what will you eat? — means the waiter is ready to take your order.',
     lines:[['ထမင်းစားပြီးပြီလား','htamin sa pi bi la','eaten yet? (a greeting)'],
      ['စားပြီးပြီ','sa pi bi','already eaten (the answer)'],
      ['စားပါ','sa ba','eat! (the host insists)'],
      ['ဘာစားမလဲ','ba sa ma leh','what will you eat?'],
      ['ရောက်ပြီ','yauq pi','we have arrived']]},
    {id:'numbers',t:'Numbers',d:'Kyat come in thousands',
     note:'Tea is a few hundred kyat, a meal a few thousand, hotels in <b>thaung</b> and <b>thein</b>. Sellers will tap the number into a calculator and turn it round to you.',
     lines:[['တစ်','tiq','1'],
      ['ငါး','nga','5'],
      ['ဆယ်','hse','10'],
      ['တစ်ရာ','tiq ya','100'],
      ['ငါးရာ','nga ya','500'],
      ['တစ်ထောင်','ta htaung','1,000'],
      ['ငါးထောင်ကျပ်','nga htaung kyaq','5,000 kyat'],
      ['သောင်း','thaung','10,000'],
      ['သိန်း','thein','100,000'],
      ['ကျပ်','kyaq','kyat']]},
    {id:'ride',t:'Getting around',d:'No meters here',
     note:'Yangon taxis have no meters — agree the fare through the window before you get in. <b>hpyei hpyei</b> asks the driver to slow down.',
     lines:[['တက္ကစီ','teq ka si','taxi'],
      ['ဘတ်စ်ကား','baq sa ka','bus'],
      ['ကား','ka','car'],
      ['ဖြည်းဖြည်း','hpyei hpyei','slowly!']]},
    {id:'way',t:'Directions',d:'Catch one word of the answer',
     note:'Ask with the <b>beh hma leh</b> frame above, then listen for these.',
     lines:[['ဘယ်ဘက်','beh beq','left side'],
      ['ညာဘက်','nya beq','right side'],
      ['ဘယ်ကွေ့','beh kweh','turn left'],
      ['ညာကွေ့','nya kweh','turn right'],
      ['တည့်တည့်','teh deh','straight ahead'],
      ['တည့်တည့်သွားပါ','teh deh thwa ba','go straight, please']]},
    {id:'eat',t:'The teashop',d:'Myanmar’s living room',
     note:'The teashop is where Myanmar sits: sweet milky <b>lahpeq yeh</b>, free refills of plain tea, mohinga for breakfast. <b>taw bi</b> stops the topping-up kindly.',
     lines:[['လက်ဖက်ရည်ဆိုင်','lahpeq yeh hsaing','the teashop'],
      ['လက်ဖက်ရည်','lahpeq yeh','sweet milk tea'],
      ['ကော်ဖီ','kaw hpi','coffee'],
      ['ထမင်း','htamin','rice · a meal'],
      ['တစ်ခွက်ပေးပါ','ta hkweq pei ba','one cup, please'],
      ['စပ်တယ်','saq de','it is spicy'],
      ['အရမ်းကောင်းတယ်','a yan kaung de','really good!'],
      ['တော်ပြီ','taw bi','that is enough']]},
    {id:'shop',t:'At the zei',d:'Bargain with a smile',
     note:'<b>shaw pei ba</b> — please lower it — with a smile does the bargaining. Money changers want crisp, unfolded dollars; <b>ma lo bu</b> — no need — waves off persistent sellers.',
     lines:[['ဈေး','zei','the market'],
      ['ဈေးကြီးတယ်','zei kyi de','it is expensive'],
      ['ဈေးပေါတယ်','zei paw de','it is cheap'],
      ['လျှော့ပေးပါ','shaw pei ba','please lower the price'],
      ['မလိုဘူး','ma lo bu','I do not need it'],
      ['ပိုက်ဆံ','paiq hsan','money'],
      ['ပိုက်ဆံလဲတယ်','paiq hsan leh de','to change money']]},
    {id:'stay',t:'Staying somewhere',d:'Rooms & torches',
     note:'<b>a hkan shi la</b> — is there a room? — is the first question at the desk. Power cuts are routine everywhere — a phone torch is standard kit, not an emergency.',
     lines:[['ဟိုတယ်','ho teh','hotel'],
      ['အခန်း','a hkan','room'],
      ['သော့','thaw','the key']]},
    {id:'trouble',t:'Getting help',d:'Serious words, hopefully unused',
     note:'<b>ku nyi ba!</b> — help, please — is the sentence to know; say it clearly. <b>ne ma kaung bu</b> tells a pharmacist how you feel; most speak some English.',
     lines:[['ကူညီပါ','ku nyi ba','help me, please!'],
      ['ရဲ','yeh','police'],
      ['ဆေးရုံ','hsei youn','hospital'],
      ['ဆရာဝန်','hsaya wun','doctor'],
      ['ဆေး','hsei','medicine'],
      ['နေမကောင်းဘူး','ne ma kaung bu','I am not feeling well'],
      ['သတိထားပါ','thadi hta ba','be careful!']]},
    {id:'connect',t:'Staying in touch',d:'Phone, wifi & photos',
     note:'SIM cards are cheap with a passport. Wifi fades outside the cities — download your maps first. Ask before photographing people; a smile and a gesture do it.',
     lines:[['ဖုန်း','hpoun','phone'],
      ['နံပါတ်','nan baq','number'],
      ['ဖုန်းနံပါတ်ဘယ်လောက်လဲ','hpoun nan baq beh lauq leh','what is your number?']]}
  ]
};
...
registerPack({
  ...
  vowels:MY_VOWELS,cons:MY_CONS,nums:MY_NUMS,srsSeed:MY_SRS_SEED,trip:MY_TRIP
});
